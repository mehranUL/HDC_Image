...
% images_train1 = double(images_train);
% images_test1 = double(images_test);
total_training_images = 60000; %MNIST 60000  11959
...
tic
classification_percentage = ECT_HDC_Meh_opt_tr_quantized_ts_noqu(image_row_size, image_column_size, D, images_train1, images_test1,...
