function cl_percentage = HDC_CIFAR10_Q(image_row_size,image_column_size,D,P_hypervector...
...
vd(:,11) = vdcorput((D-1),3);

sobol_seq1 = net(sobolset(1111), D);
sobol_seq_new = sobol_seq1(:,aa16k);
sobol_seq_new = sobol_seq_new(:,700:1023); %311
%sobol_seq_new = [sobol_seq_new,vd(:,1:9),weyl];
...
re(16384,:) = -0.01;
re = re(7000:8023,:); %for MNIST 1k 7000-8023  2000-11999
...
out_train = rescale(out_train,0,0.17);
out_test = rescale(out_test,0,0.17);
